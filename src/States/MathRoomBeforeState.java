...
public class MathRoomBeforeState extends State{
	
	private World mathRoom;
	private Dialog dialog;

	public MathRoomBeforeState(Handler handler) {
		super(handler);
	...
	public void render() {
		...
		handler.getGraphics().drawImage(Asset.crush_idle, (int) (900  - handler.getGameCamera().getxOffset()), (int) (280), null);
		handler.getGraphics().drawImage(Asset.teacher1, (int) (1000 - handler.getGameCamera().getxOffset()), (int) (280), null);
